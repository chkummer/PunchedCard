# IBM026HFORT_CardCode.sh: Card Code for IBM 026 H (Fortran)
...
# or
#   https://www.masswerk.at/misc/card-punch-typography/editor026.html
#
CONVERT_CHAR () {
case ${CURR_CHAR} in
    \ )  HOLES="";       DOT_MATRIX="00 00 00 00 00 00 00 00";;
    +)   HOLES="12";     DOT_MATRIX="00 00 10 10 7C 10 10 00";;
    ...
    \=)  HOLES="8 3";    DOT_MATRIX="00 00 00 7C 00 7C 00 00";;
    \')  HOLES="8 4";    DOT_MATRIX="00 00 00 00 00 30 30 30";;
    .)   HOLES="12 8 3"; DOT_MATRIX="00 30 30 00 00 00 00 00";;
    \))  HOLES="12 8 4"; DOT_MATRIX="00 20 10 08 08 08 10 20";;
    ...
    \()  HOLES="0 8 4";  DOT_MATRIX="00 08 10 20 20 20 10 08";;
