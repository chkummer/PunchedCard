# IBM029EBCD_CardCode.sh: Card Code for IBM 029 EBCD
...
case ${CURR_CHAR} in
    ...
    O)   HOLES="11 6";   DOT_MATRIX="00 7C 44 44 44 44 44 7C";;
    ...
    [)   HOLES="12 8 2"; DOT_MATRIX="00 70 40 40 40 40 40 70";;
    ...
    ])   HOLES="11 8 2"; DOT_MATRIX="00 38 08 08 08 08 08 38";;
    ...
    ^)   HOLES="11 8 7"; DOT_MATRIX="00 00 00 00 00 44 38 10";;
    \\)  HOLES="0 8 2";  DOT_MATRIX="00 00 04 08 10 20 40 00";;
    ...
    *)   HOLES="";       DOT_MATRIX="00 00 00 00 00 00 00 00"; echo "WARNING: can not convert char '${CURR_CHAR}' at line: '${INPUT_LINENUM}' pos: '${INPUT_POS}'";;
esac
}
