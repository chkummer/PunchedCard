# IBM026B_CardCode.sh: Card Code for IBM 026 B / Code Plate Part-No: 313334
...
case ${CURR_CHAR} in
    ...
    /)   HOLES="12";     DOT_MATRIX="00 00 40 20 10 08 04 00";;
    ...
    \&)  HOLES="0 1";    DOT_MATRIX="00 34 48 54 20 50 50 20";;
